...
pub fn boot_processor_init() {
	...
	if cfg!(feature = "vga") && !env::is_uefi() {
		#[cfg(feature = "vga")]
		vga::init();
	}
...
pub static LOADER_FB_BASE: AtomicU64 = AtomicU64::new(0);
pub static LOADER_FB_STRIDE: AtomicU64 = AtomicU64::new(0);

#[derive(Clone, Copy)]
pub(crate) enum EarlyKernelStage {
	PreInit,
	BootInfoSet,
	BootProcessorMain,
	ConsoleReady,
	...
	AfterBusyLoop,
	BeforeArchInit,
	AfterProcessorConfig,
	AfterMemoryInit,
	AfterEnvInit,
	AfterInterruptInstall,
	AfterAcpiInit,
	AfterPciInit,
	AfterApicInit,
	AfterTimerHandler,
	AfterFinishProcessorInit,
	AfterAddCurrentCore,
	AfterInterruptsEnable,
	AfterBootNextProcessor,
	AfterSpawnInitd,
	BeforeSchedulerRun,
	InitdEntry,
	AfterDriversInit,
	...
	AfterXhciInit,
	AfterXhciBarRead,
	AfterXhciCommandSetup,
	BeforeXhciCtrlNew,
	AfterXhciCtrlNew,
	BeforeXhciSettle,
	AfterXhciSettle,
	BeforeUsbDeviceProbe,
	AfterUsbDescriptorRead,
	BeforeLegacyOwnershipRequest,
	AfterLegacyOwnershipRequest,
	AfterLegacyOwnershipClear,
	AfterLegacySmiClear,
}

pub(crate) fn draw_early_kernel_marker(_stage: EarlyKernelStage) {
...
#[inline(never)]
#[unsafe(no_mangle)]
unsafe extern "C" fn pre_init(boot_info: *const RawBootInfo, cpu_id: u32) -> ! {
	processor::mark_kernel_entry_timestamp();

	// Early diagnostic print to COM1 (0x3F8)
	unsafe {
		let msg = b"KERNEL_ENTRY\n";
		for &b in msg {
